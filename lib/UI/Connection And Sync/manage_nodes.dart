...
import 'package:walletstone/UI/Connection%20And%20Sync/add_new_node.dart';
import 'package:walletstone/UI/Connection%20And%20Sync/edit_node.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const AddNewNodePage()),
                  );
                },
                child: Container(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const EditNodePage()),
                  );
                },
                child: Container(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
