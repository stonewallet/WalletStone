...
import 'package:walletstone/UI/Connection%20And%20Sync/manage_nodes.dart';
  ...
  Widget build(BuildContext context) {
    ...
    showAlertDialog(BuildContext context) {
      ...
      Widget cancelButton = TextButton(
        child: Text(
          "Cancel",
          style: RegularTextStyle.regular16700(redColor),
        ),
        onPressed: () {
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const ManageNodesPage()),
                  );
                },
                child: Container(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
