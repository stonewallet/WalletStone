...
import 'package:walletstone/UI/Security%20And%20Backup/setup2FA_next.dart';
...
class _Setup2FAState extends State<Setup2FA> {
  ...
  void initState() {
    super.initState();
    Provider.of<TwoFactorProvider>(context, listen: false).checkAuthStatus();
  }
            ...
            Consumer<ApiCreateAuth>(
              builder: (context, value, child) => InkWell(
                onTap: () async {
                  ...
                  //  var authStatus = await value.checkAuthStatus();

                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Setup2FANext()),
                  );
                },
                child: Column(
                  children: [
