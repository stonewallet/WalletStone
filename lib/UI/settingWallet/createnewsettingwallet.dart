...
import 'package:walletstone/UI/Settingwalletloading/loading_view/loding_view.dart';

TextEditingController settingwalletuserController = TextEditingController();
TextEditingController settingwalletpassController = TextEditingController();

class SettingCreateNewWallet extends StatefulWidget {
  const SettingCreateNewWallet({super.key});

  @override
  State<SettingCreateNewWallet> createState() => _SettingCreateNewWalletState();
}

class _SettingCreateNewWalletState extends State<SettingCreateNewWallet> {
  bool visibility = false;

  @override
  void initState() {
    super.initState();
    settingwalletuserController.clear();
    settingwalletpassController.clear();
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        controller: settingwalletuserController,
                    ...
                    Container(
                      ...
                      child: TextField(
                        // autofocus: true,
                        cursorColor: Colors.blue,
                        controller: settingwalletpassController,
                        textAlign: TextAlign.start,
                        textAlignVertical: TextAlignVertical.center,
                        style: RegularTextStyle.regular16600(whiteColor),
                        decoration: InputDecoration(
