...
class _StocksPageState extends State<StocksPage> {
  ...
  List<StocksModel> stocks = [
    StocksModel(
        name: "XMR",
        description: "Monero",
        image: "assets/Icons/Group79.png",
        amount: "34,396.63",
        add_minus_amount: "+135.21"),
    StocksModel(
        name: "BTC",
        description: "Bitcoin",
        image: "assets/Icons/Group78.png",
        amount: "4,478.52",
        add_minus_amount: "+39.25"),
    StocksModel(
        name: "ETH",
        description: "Ethereum",
        image: "assets/Icons/Group77.png",
        amount: "34,396.63",
        add_minus_amount: "+135.21"),
    StocksModel(
        name: "USDT",
        description: "TetherUS",
        image: "assets/Icons/Group76.png",
        amount: "111.24",
        add_minus_amount: "-1.21"),
    StocksModel(
        name: "XRP",
        description: "Ripple",
        image: "assets/Icons/Group74.png",
        amount: "108.08",
        add_minus_amount: "+0.02"),
  ];
                                          ...
                                          Text(stocks[index].name,
                                              style:
                                                  RegularTextStyle.regular15600(
                                                      whiteColor)),
                                          Text(
                                            stocks[index].description,
                                            style: LightTextStyle.light12300(
                                                whiteColor),
                                          ),
                                        ],
                                      )
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                                stocks[index].add_minus_amount,
                                                style: RegularTextStyle
                                                    .regular15600(whiteColor)),
                                          )
                                        ],
                                      ),
                                      SizedBox(
