...
class RestoreWalletLoadingView extends GetView<SplashController> {
  final RestoreWalletController splashController =
      Get.put(RestoreWalletController());
  RestoreWalletLoadingView({Key? key}) : super(key: key);
