...
class TabFourAssets extends StatefulWidget {
  final RxList<port.Portfolio> loanportfolio;

  final int _portfolio;
  final String centerTitle;
  const TabFourAssets(this.loanportfolio, this._portfolio,
      {super.key, required this.centerTitle});

  @override
  State<TabFourAssets> createState() => TabFourAssetsState();
}

class TabFourAssetsState extends State<TabFourAssets> {
