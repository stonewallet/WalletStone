...
class InnerAssetsScreen extends StatefulWidget {
  ...
  @override
  State<InnerAssetsScreen> createState() => _InnerAssetsScreenState();
}

class _InnerAssetsScreenState extends State<InnerAssetsScreen> {
                          ...
                          child: TextButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => TabTwoAssets(
                                            controller.assetsPortfolios,
                                            _portfolio,
                                            centerTitle: 'Add New Assets',
                                          )),
                                );
                              },
                              child: const Icon(
