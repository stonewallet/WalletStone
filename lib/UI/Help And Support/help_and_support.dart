  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Support", style: LargeTextStyle.large20500(whiteColor)),
      ),
      body: Column(
        children: [
          const SizedBox(
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Free and fast! Trained support representative are available to assist",
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Documentation and support for common issues",
                            style: RegularTextStyle.regular14400(whiteColor),
                            textAlign: TextAlign.start,
                          )
                        ],
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Join our communities or reach us or out partners through other methods",
                            style: RegularTextStyle.regular14400(whiteColor),
                            textAlign: TextAlign.start,
                          )
                        ],
